...
<head>
	...
	<title>Peña Olloniego F11</title>
...
<body class="index-page">
	...
	<div class="page-header header-filter" data-parallax="active" style="background-image: url('public/img/plantilla.jpg');">
		<div class="container">
			<div class="row">
				<div class="col-md-8 col-md-offset-2">
					<div class="brand">
						<h2>Peña Olloniego F11</h2>
						<h3 class="title">Bienvenidos a la Web del equipo!</h3>
					</div>
				</div>
			</div>
		</div>
