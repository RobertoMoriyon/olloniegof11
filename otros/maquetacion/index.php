...
<head>
	...
	<link href="public/css/vertical-nav.css" rel="stylesheet" />
...
<body class="index-page">
	...
	<div class="page-header header-filter clear-filter" data-parallax="active" style="background-image: url('assets/img/bg0.jpg');"></div>
	...
	<div class="main main-raised">
		<div class="section section-basic">
	    	<div class="container">
				...
				<!-- Actualidad -->
				<div id="actualidad" class="cd-section">
					<div class="row">
						<div class="col-xs-8" id="noticias">
								...
								<div class="row">
									<div class="col-md-5">
										<div class="card-image">
											<img class="img img-raised" src="public/img/card-blog4.jpg" />
										</div>
									</div>
									<div class="col-md-7">
										...
										<p class="card-description">
											Like so many organizations these days, Autodesk is a company in transition.  <a href="#pablo"> Read More </a>
										</p>
										<p class="author">
							...
							<div class="card card-plain card-blog">
								<div class="row">
									...
									<div class="col-md-5">
										<div class="card-image">
											<img class="img img-raised" src="public/img/office2.jpg" />
										</div>
									</div>
								</div>
							</div>
							...
							</div><!--Fin Titulares destacados -->
							
						</div>
						<div class="col-xs-4" id="resultados">
							<!-- Inicio Columna Resultados -->
							<div class="card card-nav-tabs card-plain">
									...
									<div class="nav-tabs-navigation">
										<div class="nav-tabs-wrapper">
											<ul class="nav nav-tabs" data-tabs="tabs">
												<li class="active"><a href="#resultados_tab" data-toggle="tab"><i class="material-icons">today</i> Resultados</a></li>
												<li><a href="#clasificacion_tab" data-toggle="tab"><i class="material-icons">list</i> Clasificación</a></li>
								...
								<div class="content">
									<div class="tab-content text-center">
										<div class="tab-pane active" id="resultados_tab">
											<ul class="list-group">
											  <li class="list-group-item">
											    <span class="badge">0-1</span>
											    <strong>Equipo 1 - Equipo 2</strong>
											    <p>Dia, Mes y xx:xx</p>
											  </li>
											  <li class="list-group-item">
											    <span class="badge">0-1</span>
										...
										<div class="tab-pane" id="clasificacion_tab">
				...
				<div id="estadisticas" class="cd-section">
				...
				</div><!-- Fin Estadísticas -->
	
				<div class="container">		        
		        <!-- Equipos -->
				<div id="equipos" class="cd-section">
				</div><!-- Fin Equipos -->
...
<nav id="cd-vertical-nav">
	<ul>
		<li>
			<a href="#actualidad" data-number="1">
				<span class="cd-dot"></span>
				<span class="cd-label">Actualidad</span>
			</a>
		</li>
		<li>
			<a href="#estadisticas" data-number="2">
				<span class="cd-dot"></span>
				<span class="cd-label">Estadísticas</span>
			</a>
		</li>
		<li>
			<a href="#equipos" data-number="3">
				<span class="cd-dot"></span>
				<span class="cd-label">Equipos</span>
			</a>
		</li>
	</ul>
</nav>
...
<!--    end small modal -->
	...
	<script src="public/js/vertical-nav.js" type="text/javascript"></script>
